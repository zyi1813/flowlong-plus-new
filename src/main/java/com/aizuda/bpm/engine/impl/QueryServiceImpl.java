...
public class QueryServiceImpl implements QueryService {
    ...
    @Override
    public FlwHisTask getStartTaskByInstanceId(Long instanceId) {
     ...
     * 获取实例列表根据创建者
     *
     * @param creatorId 造物主ID
     * @return {@link List }<{@link FlwInstance }>
     */
    @Override
    public List<FlwInstance> getInstancesListByCreator(Long creatorId) {
        return instanceDao.selectInstancesListByCreator(creatorId);
    }
}
