...
public class FlwInstanceDaoImpl implements FlwInstanceDao {
    ...
    @Override
    public List<FlwInstance> selectInstancesListByCreator(Long creatorId) {
        LambdaQueryWrapper<FlwInstance> wrapper = Wrappers.lambdaQuery(FlwInstance.class);
        wrapper.eq(FlwInstance::getCreateId, creatorId);
