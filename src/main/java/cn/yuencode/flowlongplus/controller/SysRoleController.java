...
public class SysRoleController {
    ...
    @GetMapping("/all")
    public R<Object> getAllRoles() {
        return R.success(sysRoleService.getAllRoles());
    }
    ...
    @GetMapping("/users")
    public R<Object> getUsersByRole(@RequestParam String roleId) {
        return R.success(sysRoleService.getUsersByRole(roleId));
    }
